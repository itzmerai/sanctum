...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::data::read_env_text,
            commands::entities::list_env_files,
            commands::entities::create_env_file,
            commands::entities::update_env_file,
            commands::entities::delete_env_file,
